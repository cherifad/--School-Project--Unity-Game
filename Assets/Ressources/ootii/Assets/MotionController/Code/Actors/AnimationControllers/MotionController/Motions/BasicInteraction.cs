...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class BasicInteraction : MotionControllerMotion
    {
        ...
        // Check if we're actively moving to the target
        protected bool mIsMovingToTarget = false;
        ...
        public override bool OnInspectorGUI()
        {
            ...
            {
                int lNewLayers = EditorHelper.LayerMaskField(
                    new GUIContent("Layers", "Layers that identies objects that can be interacted with."),
                    InteractableLayers);
                ...
                if (EditorHelper.TextField("Distance Root",
                    "Root position to check the distance test. While we shoot the ray from the camera, this root allows us to check the distance better. Use the HumanBodyBones names or the name of a specific transform.",
                    InteractableRaycastRoot, mMotionController))
                {
                    lIsDirty = true;
                    InteractableRaycastRoot = EditorHelper.FieldStringValue;
                }

                if (EditorHelper.FloatField("Distance", "Max ray distance used to check for interactables.",
                    InteractableDistance, mMotionController))
                {
                    lIsDirty = true;
                    InteractableDistance = EditorHelper.FieldFloatValue;
                }

                if (EditorHelper.BoolField("Interactable Core Required",
                    "Determines if an InteractableCore component is required to select a target.",
                    IsInteractableCoreRequired, mMotionController))
                {
                    lIsDirty = true;
        ...
        protected override void CreateStateMachine()
        {
            ...
            lState_N1565974.tag = "";
            lState_N1565974.motion = MotionControllerMotion.EditorFindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Interacting/Unity_IdleGrab_FrontHigh.fbx", "Idle_GrabHighFront");
            ...
            lState_N1566382.tag = "";
            lState_N1566382.motion = MotionControllerMotion.EditorFindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Interacting/unity_IdleGrab_LowFront.fbx", "Idle_PickUp");
            ...
            lState_N1567060.tag = "";
            lState_N1567060.motion = MotionControllerMotion.EditorFindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Interacting/unity_IdleGrab_Neutral.fbx", "Idle_PushButton");
            ...
            lState_N1568354.motion = MotionControllerMotion.EditorFindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx", "IdlePose");
