...
namespace Opsive.UltimateCharacterController.StateSystem
{
    ...
    public class StateManager : MonoBehaviour
    {
        ...
        private void InitializeInternal(GameObject gameObject, IStateOwner owner, State[] states)
        {
            ...
            states[states.Length - 1].Preset = Preset.CreatePreset();
        ...
        /// The Default state is always applied last.
        /// </summary>
        private void CombineStates(State[] states)
        {
            // Loop backwards so the Default state is applied first.
