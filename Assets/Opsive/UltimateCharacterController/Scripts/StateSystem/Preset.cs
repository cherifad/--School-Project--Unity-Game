...
namespace Opsive.UltimateCharacterController.StateSystem
{
    ...
    public class Preset : ScriptableObject
    {
        ...
        /// </summary>
#if NET_4_6 || UNITY_2018_3_OR_NEWER || UNITY_WEBGL || UNITY_IOS || UNITY_ANDROID || UNITY_WII || UNITY_WIIU || UNITY_PS3 || UNITY_PS4 || UNITY_XBOXONE || UNITY_WSA
...
#endif
        {
            ...
            {
                var setMethod = property.GetSetMethod(visibility != MemberVisibility.Public);
                if (setMethod != null) {
                    m_Setter = (Action<T>)Delegate.CreateDelegate(typeof(Action<T>), obj, setMethod);
#if NET_4_6 || UNITY_2018_3_OR_NEWER || UNITY_WEBGL || UNITY_IOS || UNITY_ANDROID || UNITY_WII || UNITY_WIIU || UNITY_PS3 || UNITY_PS4 || UNITY_XBOXONE || UNITY_WSA
