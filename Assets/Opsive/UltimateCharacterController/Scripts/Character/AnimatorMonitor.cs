...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    {
#if UNITY_EDITOR
        [Tooltip("Forces the Animator to update within the regular update loop. Manual updates do not allow the editor to show debug info.")]
        [SerializeField] protected bool m_DebugAnimatorController;
...
#if UNITY_EDITOR
        public bool DebugAnimatorController { get { return m_DebugAnimatorController; } }
        ...
        protected override void Awake()
        {
            ...
            if (m_Animator != null) {
                ...
                // For precise item collisions the Animator Controller should be ticked manually. During manual ticking the animator controller
                // editor does not display runtime information which makes debugging harder. Optionally allow the animator to update reguarly
                // while in the editor for easier debugging.
#if UNITY_EDITOR
                m_Animator.enabled = m_DebugAnimatorController;
#else
        ...
        /// <summary>
        /// Updates the animator when the character is dead.
        /// </summary>
        ...
        {
            // The Item ID parameters should be updated at the same time as the rest of the animator.
            if (deltaTime > 0) {
                UpdateItemIDParameters();
            }

#if UNITY_EDITOR
            if (m_DebugAnimatorController) {
                return;
            }
#endif
            if (m_ForceDisable) {
            ...
            if (m_Animator.IsInTransition(0)) {
                Debug.Log("Next: " + m_Animator.GetNextAnimatorClipInfo(0)[0].clip.name);
            }*/
            if (m_Animator != null) {
                // Prevent the animator from double updates.
                if (m_Animator.enabled && deltaTime > 0) {
                    return;
                }
            ...
            Debug for multiplayer.
            if (m_Animator.IsInTransition(0)) {
                Debug.Log("Updated Next: " + m_Animator.GetNextAnimatorClipInfo(0)[0].clip.name);
            }

            if (m_Animator.GetBool("AbilityChange")) {
                Debug.LogWarning("Update " + deltaTime + " " +  m_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime + " " + m_Animator.GetBool("AbilityChange"));
            } else {
                Debug.Log("Update " + deltaTime + " " + m_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime + " " + m_Animator.GetBool("AbilityChange"));
            }*/

            // The item's Animator should update. No update is necessary with a delta time of 0 (the IK update).
            if (deltaTime > 0 && m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].UpdateAnimator(deltaTime);
                    }
                }

                // Allow the Animators to be updated again on next frame.
        ...
        public void SetHorizontalMovementParameter(float value)
        {
            SetHorizontalMovementParameter(value, m_HorizontalMovementDampingTime);
        }
        ...
        public virtual bool SetHorizontalMovementParameter(float value, float dampingTime)
        {
            ...
            if (m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].SetHorizontalMovementParameter(value, dampingTime);
                    }
                }
            }
        ...
        /// </summary>
        /// <param name="value">The new value.</param>
        public void SetForwardMovementParameter(float value)
        {
            SetForwardMovementParameter(value, m_ForwardMovementDampingTime);
        }
        ...
        /// <param name="dampingTime">The time allowed for the parameter to reach the value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public virtual bool SetForwardMovementParameter(float value, float dampingTime)
        {
            ...
            if (m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].SetForwardMovementParameter(value, dampingTime);
                    }
                }
            }
        ...
        /// <param name="value">The new value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public void SetPitchParameter(float value)
        {
            SetPitchParameter(value, m_PitchDampingTime);
        }
        ...
        /// <param name="dampingTime">The time allowed for the parameter to reach the value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public virtual bool SetPitchParameter(float value, float dampingTime)
        {
            ...
            if (m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].SetPitchParameter(value, dampingTime);
                    }
                }
            }
        ...
        /// <param name="value">The new value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public void SetYawParameter(float value)
        {
            SetYawParameter(value, m_YawDampingTime);
        }
        ...
        /// <param name="dampingTime">The time allowed for the parameter to reach the value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public virtual bool SetYawParameter(float value, float dampingTime)
        {
            ...
            if (m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].SetYawParameter(value, dampingTime);
                    }
                }
            }
        ...
        /// <param name="dampingTime">The time allowed for the parameter to reach the value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public virtual bool SetSpeedParameter(float value, float dampingTime)
        {
            ...
            if (m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].SetSpeedParameter(value, dampingTime);
                    }
                }
            }
        ...
        /// </summary>
        /// <param name="value">The new value.</param>
        public void SetAbilityFloatDataParameter(float value)
        {
            SetAbilityFloatDataParameter(value, 0);
        }
        ...
        /// <param name="dampingTime">The time allowed for the parameter to reach the value.</param>
        /// <returns>True if the parameter was changed.</returns>
        public virtual bool SetAbilityFloatDataParameter(float value, float dampingTime)
        {
            ...
            if (m_EquippedItems != null) {
                for (int i = 0; i < m_EquippedItems.Length; ++i) {
                    if (m_EquippedItems[i] != null) {
                        m_EquippedItems[i].SetAbilityFloatDataParameter(value, dampingTime);
                    }
                }
            }
        ...
        private void OnWillEquipItem(Item item, int slotID)
        {
            ...
            m_EquippedItems[slotID].SnapAnimator();
        ...
        /// </summary>
        private void UpdateItemIDParameters()
        {
        ...
        {
            m_ForceDisable = !enable;

#if UNITY_EDITOR
            m_Animator.enabled = !m_ForceDisable && m_DebugAnimatorController;
#endif
        }
