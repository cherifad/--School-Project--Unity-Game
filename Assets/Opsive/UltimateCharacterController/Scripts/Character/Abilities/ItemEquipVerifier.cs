    ...
    public class ItemEquipVerifier : Ability
    {
        ...
        public bool TryToggleItem(Ability ability, bool activate)
        {
            ...
            if (activate && ability.AllowEquippedSlotsMask != -1) {
                ...
                if (currentEquippedSlots != 0 && currentEquippedSlots != ability.AllowEquippedSlotsMask) {
                    m_Equip = false;
                    start = true;
        ...
        protected override void AbilityStarted()
        {
            ...
            m_CanStopAbility = false;
            EventHandler.ExecuteEvent(m_GameObject, "OnAbilityToggleSlots", m_AllowEquippedSlotsMask, m_Equip);
