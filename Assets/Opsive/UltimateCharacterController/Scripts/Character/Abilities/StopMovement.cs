...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class StopMovement : StoredInputAbilityBase
    {
        ...
        public override bool CanStartAbility()
        {
            if (!base.CanStartAbility()) {
                // Only update the success count if the frames are different. This prevents the success count from being reset just because FixedUpdate
            ...
            // Wait the specified number of times to ensure the character is actually stopping.
