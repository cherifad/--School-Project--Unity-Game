    ...
    public class Interact : DetectObjectAbilityBase
    {
...
#if UNITY_EDITOR
        public override string InspectorListDescription { get { if (m_InteractableID != -1) { return "Interactable " + m_InteractableID; } return string.Empty; } }
#endif
        ...
        private void SetIKTarget(AbilityIKTarget ikTarget, Transform targetTransform)
        {
            ...
            if (targetTransform != null) {
                Scheduler.ScheduleFixed<AbilityIKTarget, Transform>(ikTarget.Duration, SetIKTarget, ikTarget, null);
            }
        }
