...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Fall : Ability
    {
        ...
        [SerializeField] protected float m_MinFallHeight = 0.3f;
        ...
        public override bool CanStartAbility()
        {
            ...
            RaycastHit hit;
            if (m_MinFallHeight != 0 && Physics.Raycast(m_Transform.position, -m_CharacterLocomotion.Up, out hit, m_MinFallHeight, m_LayerManager.SolidObjectLayers)) {
                if (hit.distance < m_MinFallHeight) {
                    return false;
                }
            }

            // Fall can be started if the character is not on the ground.
        ...
        {
            if (!IsActive || !m_CharacterLocomotion.Grounded) {
                return;
            }
