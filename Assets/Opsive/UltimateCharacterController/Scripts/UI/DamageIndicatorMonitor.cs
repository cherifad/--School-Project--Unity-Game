...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    public class DamageIndicatorMonitor : CharacterMonitor
    {
        ...
        protected override void Awake()
        {
            ...
            m_GameObject = gameObject;
            m_CameraTransform = m_CameraGameObject.transform;
        ...
        {
            // Don't show a hit indicator if the force is 0. This prevents damage such as fall damage from showing the damage indicator.
