...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    public class CrosshairsMonitor : CharacterMonitor
    {
        ...
        protected override void OnAttachCharacter(GameObject character)
        {
            ...
            var cameraController = m_Camera.gameObject.GetCachedComponent<CameraController>();
            cameraController.SetCrosshairs(transform);
        ...
        private void Update()
        {
            ...
            if (Physics.Raycast(crosshairsRay, out m_RaycastHit, Mathf.Infinity, m_CharacterLayerManager.IgnoreInvisibleLayers, QueryTriggerInteraction.Ignore)) {
