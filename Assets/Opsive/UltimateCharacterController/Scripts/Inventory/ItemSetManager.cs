...
namespace Opsive.UltimateCharacterController.Inventory
{
    ...
    public class ItemSetManager : MonoBehaviour
    {
        ...
        public ItemCollection ItemCollection { get { return m_ItemCollection; } set { m_ItemCollection = value; InitializeItemCollection(); } }
        ...
        {
            if (!Application.isPlaying || m_Inventory != null || m_ItemCollection == null) {
                return;
            }
        ...
        {
            if (categoryIndex == -1 || categoryIndex >= m_CategoryItemSets.Length || slot == -1) {
                return null;
            }
            if (m_ActiveItemSetIndex[categoryIndex] != -1) {
