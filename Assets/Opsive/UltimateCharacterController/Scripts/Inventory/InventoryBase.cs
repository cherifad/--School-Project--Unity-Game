    ...
    public abstract class InventoryBase : MonoBehaviour
    {
        ...
        public void AddItem(Item item, bool immediateEquip)
        {
            if (AddItemInternal(item)) {
                ...
                if (m_OnAddItemEvent != null && m_OnAddItemEvent.GetPersistentEventCount() > 0) {
                ...
                if ((count = GetItemTypeCount(item.ItemType)) > 0) {
                    ...
                    if (m_OnPickupItemEvent != null && m_OnPickupItemEvent.GetPersistentEventCount() > 0) {
        ...
        private void ItemTypePickup(ItemType itemType, int slotID, float count, bool immediatePickup, bool forceEquip)
        {
            ...
            if (m_OnPickupItemTypeEvent != null && m_OnPickupItemTypeEvent.GetPersistentEventCount() > 0) {
        ...
        public void UnequipItem(int slotID)
        {
            ...
            if (item != null) {
                ...
                if (m_OnUnequipItemEvent != null && m_OnUnequipItemEvent.GetPersistentEventCount() > 0) {
        ...
        public void UseItem(ItemType itemType, float count)
        {
            ...
            if (m_OnUseItemTypeEvent != null && m_OnUseItemTypeEvent.GetPersistentEventCount() > 0) {
        ...
        public void RemoveItem(ItemType itemType, int slotID, bool drop)
        {
            ...
            if (m_OnRemoveItemEvent != null && m_OnRemoveItemEvent.GetPersistentEventCount() > 0) {
