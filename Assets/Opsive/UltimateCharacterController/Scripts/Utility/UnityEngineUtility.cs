...
namespace Opsive.UltimateCharacterController.Utility
{
    ...
    public class UnityEngineUtility
    {
        ...
        {
            if (type.FullName.Contains("FirstPersonController")) {
                return "First Person " + type.Name;
            } else if (type.FullName.Contains("ThirdPersonController")) {
                return "Third Person " + type.Name;
            }
            return type.Name;
        }
