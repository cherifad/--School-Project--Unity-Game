...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Respawner : StateBehavior
    {
        ...
        [NonDefaultSerialized] public int Grouping { get { return m_Grouping; } set { m_Grouping = value; } }
        ...
        public virtual void Respawn()
        {
            ...
            if (m_OnRespawnEvent != null && m_OnRespawnEvent.GetPersistentEventCount() > 0) {
