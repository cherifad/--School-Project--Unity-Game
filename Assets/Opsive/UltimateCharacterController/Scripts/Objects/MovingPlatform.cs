...
namespace Opsive.UltimateCharacterController.Objects
{
    ...
    public class MovingPlatform : StateBehavior, IDeterministicObject, IInteractableTarget
    {
        /// <summary>
        ...
        {
            // Characters will have a LayerManager.
            var layerManager = other.gameObject.GetCachedParentComponent<LayerManager>();
