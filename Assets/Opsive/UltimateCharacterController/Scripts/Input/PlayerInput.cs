...
namespace Opsive.UltimateCharacterController.Input
{
    ...
    public abstract class PlayerInput : StateBehavior
    {
        ...
        [SerializeField] protected Vector2 m_LookSensitivity = new Vector2(3f, 3f);
        ...
        protected virtual void EnableGameplayInput(bool enable)
        {
            ...
            if (m_EnableGamplayInputEvent != null && m_EnableGamplayInputEvent.GetPersistentEventCount() > 0) {
