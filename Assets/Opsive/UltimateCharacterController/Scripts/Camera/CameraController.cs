...
namespace Opsive.UltimateCharacterController.Camera
{
    ...
    public class CameraController : StateBehavior, ILookSource
    {
        ...
        public bool CanZoom { get { return m_CanZoom; } set { m_CanZoom = value; if (m_CanZoom && m_ZoomInput && !m_Zoom) { SetZoom(true); } else if (!m_CanZoom && m_Zoom) { SetZoom(true); } } }
        ...
        {
            get { if (m_ViewTypes == null) { DeserializeViewTypes(); } return m_ViewTypes; }
            set
            {
                m_ViewTypes = value;
        ...
        public string FirstPersonViewTypeFullName { get { return m_FirstPersonViewTypeFullName; }
            set
            {
                ...
                if (Application.isPlaying) {
                    if (m_CharacterLocomotion != null && m_CharacterLocomotion.FirstPersonPerspective) {
        ...
        public void SetViewType(System.Type type, bool immediateTransition)
        {
            ...
            if (m_ViewType != null && Application.isPlaying) {
                ...
                EventHandler.ExecuteEvent(m_GameObject, "OnChangeViewTypes", m_ViewType, false);
                if (m_OnChangeViewTypesEvent != null && m_OnChangeViewTypesEvent.GetPersistentEventCount() > 0) {
            ...
            if (originalViewType != null && Application.isPlaying) {
                ...
                if (!immediateTransition && m_Transitioner != null) {
                    ...
                    if (m_ViewType.RotatePriority) {
                        DeterministicObjectManager.SetCameraRotation(m_DeterministicObjectIndex, m_ViewType.Rotate(0, 0, true));
                        DeterministicObjectManager.SetCameraPosition(m_DeterministicObjectIndex, m_ViewType.Move(true));
                    } else {
                        DeterministicObjectManager.SetCameraPosition(m_DeterministicObjectIndex, m_ViewType.Move(true));
                        DeterministicObjectManager.SetCameraRotation(m_DeterministicObjectIndex, m_ViewType.Rotate(0, 0, true));
                    }
                ...
                if (originalViewType.FirstPersonPerspective != m_ViewType.FirstPersonPerspective) {
                    ...
                    if (m_OnChangePerspectivesEvent != null && m_OnChangePerspectivesEvent.GetPersistentEventCount() > 0) {
        ...
        private void OnEnable()
        {
            ...
            m_DeterministicObjectIndex = DeterministicObjectManager.RegisterCamera(this);
        }
        ...
        private void InitializeCharacter(GameObject character)
        {
            ...
            if (m_Zoom && m_Character != null && !string.IsNullOrEmpty(m_ZoomState)) {
                StateManager.SetState(m_Character, m_ZoomState, false);
                ...
                if (m_CharacterInventory != null && m_StateAppendItemTypeName) {
                    for (int i = 0; i < m_CharacterInventory.SlotCount; ++i) {
                        ...
                        if (item != null && item.IsActive()) {
                            ...
                            StateManager.SetState(m_Character, itemStateName, false);
                        }
                    }
                }
            }
        ...
        {
            DeterministicObjectManager.UnregisterCamera(m_DeterministicObjectIndex);
        }
