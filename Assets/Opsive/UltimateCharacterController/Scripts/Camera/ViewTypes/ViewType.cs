...
namespace Opsive.UltimateCharacterController.Camera.ViewTypes
{
    ...
    public abstract class ViewType : StateObject
    {
        ...
        protected LayerManager m_CharacterLayerManager;
        ...
        public virtual void AttachCharacter(GameObject character)
        {
            ...
            if (m_Character == null) {
                ...
                m_CharacterLayerManager = character.GetCachedComponent<LayerManager>();
            }
        }
    ...
    /// <summary>
    /// Attribute which allows the view type to add a new state when added to the camera.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
    public class AddViewState : Attribute
    {
        private string m_Name;
        private string m_PresetGUID;
        public string Name { get { return m_Name; } }
        public string PresetGUID { get { return m_PresetGUID; } }
        public AddViewState(string name, string presetGUID)
        {
            m_Name = name;
