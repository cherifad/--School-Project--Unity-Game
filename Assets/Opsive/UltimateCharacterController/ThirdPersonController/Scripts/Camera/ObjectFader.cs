...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Camera
{
    ...
    public class ObjectFader : StateBehavior
    {
        ...
        public bool CharacterFade { get { return m_CharacterFade; } set { m_CharacterFade = value; } }
        ...
        public bool ObstructingObjectsFade { get { return m_ObstructingObjectsFade; } set { m_ObstructingObjectsFade = value; } }
        ...
        private LayerManager m_CharacterLayerManager;
        ...
        protected virtual void OnAttachCharacter(GameObject character)
        {
            ...
            if (m_Character != null) {
                if (m_CharacterFade) {
                    ...
                    m_CharacterLayerManager = m_Character.GetCachedComponent<LayerManager>();
        ...
        protected virtual bool FadeMaterial(Material material, bool fade, bool immediateFade)
        {
            ...
            // Add -1 or 1 to the target so lerp will change the value with a constant amount (this is most noticeable near the target value).
