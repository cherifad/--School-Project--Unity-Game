    ...
    public class RPG : ThirdPerson
    {
        ...
        public override Quaternion Rotate(float horizontalMovement, float verticalMovement, bool immediatePosition)
        {
            ...
            if (m_FreeMovement) {
                ...
                m_YawOffset = Mathf.SmoothDamp(m_YawOffset, 0, ref m_YawSnapVelocity, m_YawSnapDamping * m_CharacterLocomotion.TimeScale * TimeUtility.FramerateFixedDeltaTimeScaled);
            }
