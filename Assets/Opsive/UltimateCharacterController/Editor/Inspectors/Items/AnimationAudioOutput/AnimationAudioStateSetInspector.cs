...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.AnimatorAudioState
{
    ...
    public static class AnimatorAudioStateSetInspector
    {
        ...
        /// </summary>
        public static void DrawAnimatorAudioStateSet(UnityEngine.Object target, AnimatorAudioStateSet animatorAudioStateSet, bool randomDefaultSelector, 
                                                ...
                                                ReorderableList.RemoveCallbackDelegate stateRemoveCallback, string statePreferencesKey)
        {
            ...
            animatorAudioState.AllowDuringMovement = EditorGUILayout.Toggle("Allow During Movement", animatorAudioState.AllowDuringMovement);
            animatorAudioState.RequireGrounded = EditorGUILayout.Toggle("Require Grounded", animatorAudioState.RequireGrounded);
            animatorAudioState.ItemSubstateIndex = EditorGUILayout.IntField("Item Substate Index", animatorAudioState.ItemSubstateIndex);
            AudioClipSetInspector.DrawAudioClipSet(animatorAudioState.AudioClipSet, ref reorderableAudioList, drawAudioElementCallback, addAudioCallback, removeAudioCallback);
        ...
        /// </summary>
        public static void OnAnimatorAudioStateElementDraw(AnimatorAudioStateSet animatorAudioStateSet, Rect rect, int index, bool isActive, bool isFocused, UnityEngine.Object target)
        {
        ...
        public static void OnAnimatorAudioStateListAdd(ReorderableList list, AnimatorAudioStateSet animatorAudioStateSet, string preferencesKey)
        {
            ...
            EditorPrefs.SetInt(preferencesKey, states.Length - 1);
        }
        ...
        public static void OnAnimatorAudioStateListRemove(ReorderableList list, AnimatorAudioStateSet animatorAudioStateSet, string preferencesKey)
        {
            ...
            list.displayRemove = stateList.Count > 1;
        ...
        /// </summary>
        public static void OnAudioClipDraw(Rect rect, int index, AnimatorAudioStateSet.AnimatorAudioState[] animatorAudioStates, string preferencesKey, UnityEngine.Object target)
        {
            var state = animatorAudioStates[EditorPrefs.GetInt(preferencesKey, 0)];
            AudioClipSetInspector.OnAudioClipDraw(rect, index, state.AudioClipSet, target);
        }
