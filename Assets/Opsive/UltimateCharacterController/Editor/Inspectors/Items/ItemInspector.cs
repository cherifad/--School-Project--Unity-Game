...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items
{
    ...
    public class ItemInspector : StateBehaviorInspector
    {
            ...
            baseCallback += () =>
            {
                ...
                if (Foldout("Equip")) {
                    ...
                    if (Foldout("Animator Audio")) {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_Item, m_Item.EquipAnimatorAudioStateSet, true,
                ...
                if (Foldout("Unequip")) {
                    ...
                    if (Foldout("Animator Audio")) {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_Item, m_Item.UnequipAnimatorAudioStateSet, true,
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(rect, index, m_Item.EquipAnimatorAudioStateSet.States, SelectedEquipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(rect, index, m_Item.UnequipAnimatorAudioStateSet.States, SelectedUnequipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_Item.EquipAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_Item.UnequipAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
