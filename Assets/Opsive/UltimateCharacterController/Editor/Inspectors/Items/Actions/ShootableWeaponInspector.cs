...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    public class ShootableWeaponInspector : UsableItemInspector
    {
            ...
            baseCallback += () =>
            {
                if (Foldout("Firing")) {
                    ...
                    if (fireType.enumValueIndex != (int)ShootableWeapon.FireType.Instant) {
                        ...
                        if (Foldout("Charge Audio")) {
                            EditorGUI.indentLevel++;
                            AudioClipSetInspector.DrawAudioClipSet(m_ShootableWeapon.ChargeAudioClipSet, ref m_ReorderableChargeAudioClipsList, OnChargeAudioClipDraw, OnChargeAudioClipListAdd, OnChargeAudioClipListRemove);
                            EditorGUI.indentLevel--;
                        }
                        EditorGUI.indentLevel--;
                    }
                    ...
                    if (InspectorUtility.Foldout(target, "Dry Fire Audio")) {
                        EditorGUI.indentLevel++;
                        AudioClipSetInspector.DrawAudioClipSet(m_ShootableWeapon.DryFireAudioClipSet, ref m_ReorderableDryFireAudioClipsList, OnDryFireAudioClipDraw, OnDryFireAudioClipListAdd, OnDryFireAudioClipListRemove);
                        EditorGUI.indentLevel--;
                    }
                    EditorGUI.indentLevel--;
                }
                ...
                if (Foldout("Reload")) {
                    ...
                    if (Foldout("Animator Audio")) {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_ShootableWeapon, m_ShootableWeapon.ReloadAnimatorAudioStateSet, true,
                    ...
                    if (InspectorUtility.Foldout(target, "Reload Complete Audio")) {
                        EditorGUI.indentLevel++;
                        AudioClipSetInspector.DrawAudioClipSet(m_ShootableWeapon.ReloadCompleteAudioClipSet, ref m_ReorderableReloadCompleteAudioClipsList, OnReloadCompleteAudioClipDraw, OnReloadCompleteAudioClipListAdd, OnReloadCompleteAudioClipListRemove);
                        EditorGUI.indentLevel--;
                    }
                }
                if (Foldout("Recoil")) {
                ...
                if (Foldout("Tracer")) {
                    ...
                    if (PropertyFromName("m_Projectile").objectReferenceValue == null) {
                        var smoke = PropertyFromName("m_Tracer");
                        EditorGUILayout.PropertyField(smoke);
                        if (smoke.objectReferenceValue != null) {
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(rect, index, m_ShootableWeapon.DryFireAudioClipSet, null);
        }
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(rect, index, m_ShootableWeapon.ReloadCompleteAudioClipSet, null);
        }
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(rect, index, m_ShootableWeapon.ChargeAudioClipSet, null);
        }
        ...
        private void OnDryFireAudioClipListRemove(ReorderableList list)
        {
            ...
            m_ShootableWeapon.DryFireAudioClipSet.AudioClips = (AudioClip[])list.list;
        }
        ...
        private void OnReloadCompleteAudioClipListRemove(ReorderableList list)
        {
            ...
            m_ShootableWeapon.ReloadCompleteAudioClipSet.AudioClips = (AudioClip[])list.list;
        }
        ...
        private void OnChargeAudioClipListRemove(ReorderableList list)
        {
            ...
            m_ShootableWeapon.ChargeAudioClipSet.AudioClips = (AudioClip[])list.list;
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(rect, index, m_ShootableWeapon.ReloadAnimatorAudioStateSet.States, SelectedReloadAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_ShootableWeapon.ReloadAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
