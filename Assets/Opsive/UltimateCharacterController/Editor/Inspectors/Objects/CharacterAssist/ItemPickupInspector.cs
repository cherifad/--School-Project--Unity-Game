...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Objects.CharacterAssist
{
    ...
    public class ItemPickupInspector : ObjectPickupInspector
    {
        ...
        private void OnPickupSetElementDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            GUI.Label(rowRect, "", InspectorUtility.FieldStyle);

            // Draw the ItemSet title.
            var elementTitleRect = rowRect;
            elementTitleRect.y += 2;
            elementTitleRect.height = 19;
            GUI.Label(elementTitleRect, "PickupSet " + index, InspectorUtility.CenterBoldLabel);
            ...
            for (int i = 0; i < m_SlotCount + 1; ++i) {
                ...
                GUI.Label(slotRect, "", InspectorUtility.ItemStyle);
                GUI.color = color;
        ...
        {
            ItemTypeCountInspector.OnItemTypeCountElementDraw((target as ItemPickup).ItemTypeCounts, rect, index, isActive, isFocused);
        }
        ...
        {
            GUILayout.Label("Pickup Set " + index, InspectorUtility.CenterBoldLabel);
