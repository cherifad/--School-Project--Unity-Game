...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Inventory
{
    ...
    public static class ItemTypeCountInspector
    {
        ...
        /// </summary>
        public static void OnItemTypeCountElementDraw(ItemTypeCount[] itemTypeAmounts, Rect rect, int index, bool isActive, bool isFocused)
        {
            var objRect = rect;
            objRect.x -= 12;
            ...
            objRect.height = 16;
            itemTypeAmounts[index].ItemType = (ItemType)EditorGUI.ObjectField(objRect, itemTypeAmounts[index].ItemType, typeof(ItemType), false);
            ...
            valueRect.height = 16;
            itemTypeAmounts[index].Count = EditorGUI.FloatField(valueRect, itemTypeAmounts[index].Count);
        }
    }
}