...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Traits
{
    ...
    public class RespawnerInspector : StateBehaviorInspector
    {
        ...
        protected override Action GetDrawCallback()
        {
            ...
            baseCallback += () =>
            {
                ...
                if (Foldout("Respawn Audio")) {
                    EditorGUI.indentLevel++;
                    AudioClipSetInspector.DrawAudioClipSet(m_Respawner.RespawnAudioClipSet, ref m_ReorderableRespawnAudioClipsList, OnRespawnAudioClipDraw, OnRespawnAudioClipListAdd, OnRespawnAudioClipListRemove);
                    EditorGUI.indentLevel--;
                }
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(rect, index, m_Respawner.RespawnAudioClipSet, null);
        }
