...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Character.Effects
{
    ...
    public class PlayAudioClipInspectorDrawer : InspectorDrawer
    {
        ...
        public override void OnInspectorGUI(object target, Object parent)
        {
            ...
            AudioClipSetInspector.DrawAudioClipSet(m_PlayAudioClip.AudioClipSet, ref m_AudioClipsList, OnAudioClipDraw, OnAudioClipListAdd, OnAudioClipListRemove);
        }
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(rect, index, m_PlayAudioClip.AudioClipSet, null);
        }
