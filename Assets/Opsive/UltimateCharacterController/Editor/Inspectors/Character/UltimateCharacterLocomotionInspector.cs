...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Character
{
    ...
    public class UltimateCharacterLocomotionInspector : StateBehaviorInspector
    {
        ...
        private int m_SelectedFirstPersonMovementTypeIndex;
        private int m_SelectedThirdPersonMovementTypeIndex;
        ...
        protected override Action GetDrawCallback()
        {
            ...
            baseCallback += () =>
            {
                ...
                if (!string.IsNullOrEmpty(m_CharacterLocomotion.FirstPersonMovementTypeFullName) && !string.IsNullOrEmpty(m_CharacterLocomotion.ThirdPersonMovementTypeFullName)) {
                    var selectedIndex = 0;
                    ...
                    index = EditorGUILayout.Popup("Third Person Movement Type", selectedIndex, m_ThirdPersonMovementTypeNames);
                    if (index != selectedIndex) {
                ...
                if (Foldout("Motor")) {
                    ...
                    EditorGUI.indentLevel--;
                    EditorGUILayout.PropertyField(PropertyFromName("m_MotorAirAcceleration"));
                    EditorGUILayout.PropertyField(PropertyFromName("m_MotorAirDamping"));
                ...
                if (Foldout("Physics")) {
                    ...
                    EditorGUILayout.PropertyField(PropertyFromName("m_MaxStepHeight"));
                    ...
                    if (useGravity.boolValue) {
                        ...
                        EditorGUILayout.PropertyField(PropertyFromName("m_GravityModifier"));
                        EditorGUI.indentLevel--;
                    }
                ...
                if (Foldout("Movement")) {
                    ...
                    var alignToGround = PropertyFromName("m_AlignToGround");
                    EditorGUILayout.PropertyField(alignToGround);
                    if (alignToGround.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(PropertyFromName("m_AlignToGroundDistance"));
                        EditorGUILayout.PropertyField(PropertyFromName("m_AlignToGroundDepthOffset"));
                        EditorGUILayout.PropertyField(PropertyFromName("m_AlignToGroundNormalizeDirection"));
                        EditorGUILayout.PropertyField(PropertyFromName("m_AlignToGroundRotationSpeed"));
                        EditorGUI.indentLevel--;
                    }
                    EditorGUI.indentLevel--;
                }
                ...
                // The remaining controls don't need to draw if they're not visible.
        ...
        private void OnMovementTypeListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (EditorGUI.EndChangeCheck()) {
                ...
                m_CharacterLocomotion.MovementTypeFullName = movementType.GetType().FullName;
        ...
        private void OnAbilityListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var description = ability.InspectorListDescription;
        ...
        private void OnItemAbilityListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var description = itemAbility.InspectorListDescription;
            if (!string.IsNullOrEmpty(description)) {
                label += " (" + description + ")";
            }
        ...
        private void AddMovementType(object obj)
        {
            ...
            if (m_CharacterLocomotion.GetComponent<ThirdPersonController.Character.PerspectiveMonitor>() == null) {
                ...
                if (hasFirstPersonMovementType && hasThirdPersonMovementType) {
                    m_CharacterLocomotion.gameObject.AddComponent<ThirdPersonController.Character.PerspectiveMonitor>();
                }
            }
#endif
        ...
        private void OnMovementTypeListRemove(ReorderableList list)
        {
            ...
            if (m_CharacterLocomotion.GetComponent<ThirdPersonController.Character.PerspectiveMonitor>() != null) {
                ...
                if (!hasFirstPersonMovementType || !hasThirdPersonMovementType) {
                    DestroyImmediate(m_CharacterLocomotion.gameObject.GetComponent<ThirdPersonController.Character.PerspectiveMonitor>(), true);
                }
            }
#endif
        ...
        /// </summary>
        private void DrawSelectedMovementType(object movementType)
        {
        ...
        /// </summary>
        private void DrawSelectedAbility(object ability)
        {
            ...
            if (inspectorDrawer != null) {
                ...
                if ((editorCallback != null || inspectorDrawer.CanBuildAnimator || ability.AbilityIndexParameter != -1) && InspectorUtility.Foldout(ability, new GUIContent("Editor"), false)) {
                    ...
                    if (GUILayout.Button("Generate Animator Code")) {
                        var baseDirectory = System.IO.Path.GetDirectoryName(AssetDatabase.GetAssetPath(MonoScript.FromScriptableObject(this)));
                        inspectorDrawer.GenerateAnimatorCode(ability, animatorController, baseDirectory);
                    }
                    GUI.enabled = GUI.enabled && inspectorDrawer.CanBuildAnimator;
                    if (GUILayout.Button("Build Animator")) {
                        inspectorDrawer.BuildAnimator(animatorController);
                    }
                    GUI.enabled = true;
        ...
        /// </summary>
        private void DrawSelectedItemAbility(object itemAbility)
        {
        ...
        /// </summary>
        private void DrawSelectedEffect(object effect)
        {
