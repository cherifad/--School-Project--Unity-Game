...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class ItemManager : Manager
    {
        ...
        [SerializeField] private RuntimeAnimatorController m_FirstPersonObjectAnimatorController;
        [SerializeField] private GameObject m_FirstPersonVisibleItem;
        [SerializeField] private RuntimeAnimatorController m_FirstPersonVisibleItemAnimatorController;
        ...
        [SerializeField] private string m_AddBaseConfigName;
        ...
        public override void OnGUI()
        {
            ...
            if (m_DrawNewItems) {
                GUILayout.Label("New Item", InspectorUtility.CenterBoldLabel);
                DrawNewItem();
            } else {
                GUILayout.Label("Existing Item", InspectorUtility.CenterBoldLabel);
                DrawExistingItem();
            }
        }
        ...
        private void DrawNewItem()
        {
...
#if FIRST_PERSON_CONTROLLER
            GUILayout.Space(5);
            GUILayout.Label("First Person", InspectorUtility.BoldLabel);
            ...
            var firstPersonSuccess = DrawFirstPersonObject(m_Character, ref m_FirstPersonObject, ref m_FirstPersonObjectAnimatorController, ref m_FirstPersonVisibleItem, 
                                                                ...
                                                                m_ThirdPersonItemSlot != null ? m_ThirdPersonItemSlot.ID : 0, characterUpdate, canBuild);
            GUI.enabled = true;
            ...
            if (m_Character == null || (m_Character != null && m_Character.GetComponent<Animator>() != null)) {
                GUILayout.Space(10);
                GUILayout.Label("Third Person (including AI and multiplayer)", InspectorUtility.BoldLabel);
                ...
                var thirdPersonSuccess = DrawThirdPersonObject(m_Character, ref m_ThirdPersonObject, ref m_ThirdHumanoidParentHand, ref m_ThirdPersonParent, ref m_ThirdPersonItemSlot,
                                                                        ref m_ThirdPersonObjectAnimatorController, m_FirstPersonItemSlot != null ? m_FirstPersonItemSlot.ID : 0, characterUpdate, canBuild);
                GUI.enabled = true;
            ...
            if (GUILayout.Button("Build Item")) {
                ...
                if (m_FirstPersonVisibleItem != null && string.IsNullOrEmpty(AssetDatabase.GetAssetPath(m_FirstPersonVisibleItem)) &&
                ...
                if (m_FirstPersonObject != null && string.IsNullOrEmpty(AssetDatabase.GetAssetPath(m_FirstPersonObject)) && 
                ...
                if (m_ThirdPersonObject != null && string.IsNullOrEmpty(AssetDatabase.GetAssetPath(m_ThirdPersonObject)) &&
                                            ...
                                            int defaultItemSlotIndex, bool characterUpdate, bool showError)
        {
            ...
            Animator animator;
            if (firstPersonObject != null && ((animator = firstPersonObject.GetComponent<Animator>()) == null || (animator.runtimeAnimatorController == null))) {
                EditorGUI.indentLevel++;
            ...
            if ((character != null && (firstPersonObject == null && firstPersonVisibleItem != null)) ||
                ...
                if (firstPersonParent == null) {
                    ...
                    if ((firstPersonObject == null && firstPersonParent.GetComponentInParent<FirstPersonController.Character.FirstPersonObjects>() == null) || 
                                                ...
                                                int defaultItemSlotIndex, bool characterUpdate, bool showError)
        {
            ...
            if (thirdPersonObject != null && character != null) {
                ...
                if (prevThirdPersonObject != thirdPersonObject || characterUpdate) {
                    var itemSlots = character.GetComponents<ItemSlot>();
                ...
                if (thirdPersonParent == null) {
                    ...
                    if (thirdPersonParent.GetComponentInParent<FirstPersonController.Character.FirstPersonObjects>() != null) {
                        invalidItemSlot = true;
                    } else {
#endif
        ...
        private GameObject AddItemSlot(GameObject baseParent, Transform itemParent, bool firstPerson)
        {
            ...
            var maxID = -1;
#if FIRST_PERSON_CONTROLLER
            var firstPersonObjects = baseParent.GetComponentInChildren<FirstPersonController.Character.FirstPersonObjects>();
#endif
        ...
        private void DrawExistingItem()
        {
...
#if FIRST_PERSON_CONTROLLER
                var firstPersonVisibleItemObject = m_Item.GetComponent<FirstPersonController.Items.FirstPersonPerspectiveItem>();
                if (firstPersonVisibleItemObject != null) {
                    ItemBuilder.RemoveFirstPersonObject(firstPersonVisibleItemObject);
                }
#endif
                var thirdPersonVisibleItemObject = m_Item.GetComponent<ThirdPersonController.Items.ThirdPersonPerspectiveItem>();
            ...
            EditorGUILayout.LabelField("First Person", InspectorUtility.BoldLabel);
            EditorGUI.indentLevel++;
            ...
            if (m_Item != null) {
                ...
                DrawFirstPersonObject(character.gameObject, ref m_ExistingFirstPersonObject, ref m_ExistingFirstPersonObjectAnimatorController, 
            ...
            GUI.enabled = m_Item != null;
            GUILayout.Space(5);
            EditorGUILayout.LabelField("Third Person", InspectorUtility.BoldLabel);
            EditorGUI.indentLevel++;
            ...
            if (m_Item != null) {
                ...
                if (character == null || (character != null && character.GetComponent<Animator>() != null)) {
                    DrawThirdPersonObject(character.gameObject, ref m_ExistingThirdPersonObject, ref m_ExistingThirdHumanoidParentHand, ref m_ExistingThirdPersonParent,
            ...
            // Setup profiles.
            GUILayout.Space(5);
            EditorGUILayout.LabelField("State Profile", InspectorUtility.BoldLabel);
