...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public static class ManagerUtility
    {
        ...
        public static RuntimeAnimatorController FindAnimatorController(ScriptableObject editorWindow)
        {
            ...
            animatorControllerPath = System.IO.Path.GetDirectoryName(AssetDatabase.GetAssetPath(MonoScript.FromScriptableObject(editorWindow))).Replace("Editor/Managers", "Demo/Animator/Characters/Demo.controller");
