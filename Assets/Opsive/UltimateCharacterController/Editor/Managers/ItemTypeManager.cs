...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class ItemTypeManager : Manager
    {
        ...
        public override void OnGUI()
        {
            ...
            if (m_DrawItemType) {
                GUILayout.Label("Item Types", InspectorUtility.CenterBoldLabel);
            } else {
                GUILayout.Label("Categories", InspectorUtility.CenterBoldLabel);
            }
    ...
    public class CategoryCollectionModal : TreeModal
    {
        ...
        private void DrawDetails(Rect rowRect, int id)
        {
            ...
            rect.x += 4;
            rect.y += c_RowHeight;
            Undo.RecordObject(m_ItemCollection, "Category Change");
    ...
    public class ItemTypeCollectionModal : TreeModal
    {
        ...
        private void DrawDetails(Rect rowRect, int id)
        {
            ...
            var itemType = m_ItemCollection.ItemTypes[id];
            Undo.RecordObject(itemType, "ItemType Change");
            ...
            itemType.Description = InspectorUtility.DrawEditorWithoutSelectAll(() => EditorGUI.TextArea(descriptionRect, itemType.Description, InspectorUtility.WordWrapTextArea));
