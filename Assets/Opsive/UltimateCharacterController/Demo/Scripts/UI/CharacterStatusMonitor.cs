...
namespace Opsive.UltimateCharacterController.Demo.UI
{
    ...
    public class CharacterStatusMonitor : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            EventHandler.RegisterEvent<MovementType, bool>(character, "OnChangeMovementType", OnMovementTypeChanged);
        }
        ...
        private void OnDestroy()
        {
            if (m_CharacterLocomotion != null) {
                EventHandler.UnregisterEvent<MovementType, bool>(m_CharacterLocomotion.gameObject, "OnChangeMovementType", OnMovementTypeChanged);
            }
        }
    }
}